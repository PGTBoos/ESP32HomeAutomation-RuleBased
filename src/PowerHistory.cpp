...
const int PowerHistory::MINUTE_POINTS;
const int PowerHistory::HOUR_POINTS;
const int PowerHistory::DAY_POINTS;
const int PowerHistory::MONTH_POINTS;
